    ...
    return ( 
        <div>
            <div className="w-full py-8 px-6 flex flex-col space-y-4">
                ...
                <input className=" text-black w-full h-12 pl-9 bg-[#000000] bg-opacity-10 rounded-lg outline-none" type="text" name="search"/>
                <img className="w-4 h-4 absolute top-12 right-10" src={cancel}/>
                </div>
                <div className="w-full flex items-center justify-between">
                <div className="bg-[#FB6D3A] rounded-lg text-xs px-9 py-3 text-white font-medium">Фастфуд(12)</div>
